...
urlpatterns = [
    ...
    url(r'^item/$', PortfolioItemAPIView.as_view(), name="item"),
    url(r'^item/(?P<pk>\d+)/$',PortfolioItemDetailAPIView.as_view(), name="item-detail"),
    #
    # url(r'^portfolio/(?P<pk>\d+)/diagnosis/$',PortfolioDiagnosisAPIView.as_view(), name="portfolio-diagnosis"),
